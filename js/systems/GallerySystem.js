...
export class GallerySystem {
    ...
    initBossData() {
        return [
            ...
            // 特殊解锁 - BSD系列
            { id: 'bsd_swim', level: 6, name: '波塞冬·??', title: 'Poseidon ??', isMutated: false, image: 'bsd swim.PNG', wideImage: true, lockedImage: 'bsd locked.PNG', unlockType: 'poseidon_kills', unlockCount: 3, unlockHint: '击败波塞冬3次解锁' },
            { id: 'bsd_swimsuit', level: 6, name: '波塞冬·???', title: 'Poseidon ???', isMutated: false, image: 'bsd swim suit.PNG', wideImage: true, lockedImage: 'bsd locked.PNG', unlockType: 'all_except_lv7', unlockCount: 3, unlockHint: '除Lv7外全Boss击杀3次解锁' },
